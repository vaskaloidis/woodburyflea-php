...
<div class="main">
    <div class="container">
        <section class="hgroup">
            <h1>Come Visit The Woodbury Flea Market</h1>
            <h2>25 Sherman Hill Rd. Woodbury, CT 06798</h2>
            <h2>(203) 263 - 6217</h2>
            <h2><a href="mailto:thenewwoodburyfleamarket@gmail.com">thenewwoodburyfleamarket@gmail.com</a></h2>
        ...
        <section class="article-text">
            <div class="row">
                <div class=".col-xs-12 .col-sm-6 .col-lg-8">
                    <div class="lead"></p><?= $ContentDAO->getContent('directions')->getContent(); ?></div>
                    <br>
                    <iframe
